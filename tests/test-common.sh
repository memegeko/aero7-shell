...
[[ "$preferred_wallpaper" == "$repo/assets/wallpapers/aero7-background.png" ]] || fail "wallpaper resolver picked wrong default: $preferred_wallpaper"
...
wallpaper="$repo/assets/wallpapers/aero7-background.png"
...
[[ "$kde_path" == "/usr/share/wallpapers/Aero7ShellDefault/contents/images/1672x941.png" ]] || fail "unexpected KDE wallpaper package path: $kde_path"
[[ "$(aero7_wallpaper_package_field "$wallpaper" name)" == "Aero7" ]] || fail "default wallpaper package name changed"
! aero7_wallpaper_is_allowed "$repo/assets/wallpapers/retired-background.png" || fail "retired wallpaper was allowed"
