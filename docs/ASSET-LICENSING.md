...
Only assets listed here may be distributed by Aero7-shell.

| Filename | Creator | Source | Licence | Modification Allowed | Attribution Requirements |
| --- | --- | --- | --- | --- | --- |
...
- Original or edited Windows 7 wallpapers
- Microsoft Windows logos
- Microsoft usertile BMP files
